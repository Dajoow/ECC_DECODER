...
REM
REM Generated by Vivado on Mon Jun 01 21:11:38 +0800 2026
...
echo "xvlog --incr --relax -prj tb_ecc_decoder_vlog.prj"
call xvlog  --incr --relax -prj tb_ecc_decoder_vlog.prj -log xvlog.log
